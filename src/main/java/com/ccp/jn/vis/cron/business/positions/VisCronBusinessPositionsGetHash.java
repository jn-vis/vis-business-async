...
public class VisCronBusinessPositionsGetHash implements  java.util.function.Function<CcpJsonRepresentation, CcpJsonRepresentation>{
	private JnAsyncBusinessCommitAndAudit commitAndAudit = new JnAsyncBusinessCommitAndAudit();
	//TODO CALCULAR HASH DA VAGA
