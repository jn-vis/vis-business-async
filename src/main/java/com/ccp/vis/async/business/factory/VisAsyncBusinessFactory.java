...
import com.ccp.vis.async.business.resume.VisAsyncBusinessResumeInactivate;
...
class VisAsyncBusinessFactory implements CcpAsyncBusinessFactory {
	...
	private VisAsyncBusinessFactory() {
		...
		this.map.put(VisAsyncBusiness.inactivateResume.name(),VisAsyncBusinessResumeInactivate.INSTANCE);
		...
		this.map.put(VisAsyncBusiness.saveResume.name(), VisAsyncBusinessResumeSave.INSTANCE);
