...
public class VisAsyncBusinessPositionStatusChange implements  Function<CcpJsonRepresentation, CcpJsonRepresentation>{
	...
	public CcpJsonRepresentation apply(CcpJsonRepresentation json) {
		Function<CcpJsonRepresentation, CcpJsonRepresentation> whenPositionIsInactivated = data -> VisAsyncUtils.groupPositionsByRecruiters(data.duplicateValueFromField("email", "masters"));
